...
*
* <p>lets you draw around the large-bird.gif image, generating polygon vertexcoordinates on the
...
* Any remaining arguments are assumed to be a comma-separated list of polygonvertex coordinates,
* in the same format as the parameter list to city.soi.platform.PolygonShape(float...).
*/
public static void main(String[] args) {
String fileName = "images/Supermanfaceright.gif";
